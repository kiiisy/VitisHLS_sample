...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_TrafficLight is
  signal and_ln14_fu_248_p2 : STD_LOGIC;
  ...
  signal \cnt_reg[0]_i_14_n_1\ : STD_LOGIC;
  ...
  signal \cnt_reg[0]_i_16_n_1\ : STD_LOGIC;
  signal \cnt_reg[0]_i_16_n_2\ : STD_LOGIC;
  signal \cnt_reg[0]_i_16_n_3\ : STD_LOGIC;
  signal \cnt_reg[0]_i_17_n_2\ : STD_LOGIC;
  signal \cnt_reg[0]_i_17_n_3\ : STD_LOGIC;
  signal \cnt_reg[0]_i_18_n_0\ : STD_LOGIC;
  signal \cnt_reg[0]_i_18_n_1\ : STD_LOGIC;
  signal \cnt_reg[0]_i_18_n_2\ : STD_LOGIC;
  signal \cnt_reg[0]_i_18_n_3\ : STD_LOGIC;
  ...
  signal or_ln_fu_204_p3 : STD_LOGIC_VECTOR ( 7 downto 1 );
  signal pre_state : STD_LOGIC;
  signal pre_state0 : STD_LOGIC;
  signal \pre_state[0]_i_2_n_0\ : STD_LOGIC;
  signal \pre_state[0]_i_3_n_0\ : STD_LOGIC;
  signal \pre_state[0]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \NLW_cnt_reg[0]_i_17_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_cnt_reg[0]_i_17_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \cnt[0]_i_13\ : label is "soft_lutpair0";
  ...
  attribute ADDER_THRESHOLD of \cnt_reg[0]_i_18\ : label is 35;
  ...
  attribute SOFT_HLUTNM of \yellow[0]_INST_0\ : label is "soft_lutpair2";
begin
  \^ap_start\ <= ap_start;
  ap_done <= \^ap_start\;
  ap_ready <= \^ap_start\;
...
\cnt[0]_i_11\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFEFFFFF"
    )
        port map (
...
\cnt[0]_i_12\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\cnt[0]_i_19\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
\cnt[0]_i_23\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\cnt_reg[0]_i_14\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2) => \cnt_reg[0]_i_14_n_1\,
      CO(1) => \cnt_reg[0]_i_14_n_2\,
      CO(0) => \cnt_reg[0]_i_14_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_163_p2(20 downto 17),
...
\cnt_reg[0]_i_15\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_163_p2(28 downto 25),
...
\cnt_reg[0]_i_16\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2) => \cnt_reg[0]_i_16_n_1\,
      CO(1) => \cnt_reg[0]_i_16_n_2\,
      CO(0) => \cnt_reg[0]_i_16_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_163_p2(24 downto 21),
      S(3 downto 0) => cnt_reg(24 downto 21)
    );
\cnt_reg[0]_i_17\: unisim.vcomponents.CARRY4
     port map (
      CI => \cnt_reg[0]_i_15_n_0\,
      CO(3 downto 2) => \NLW_cnt_reg[0]_i_17_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \cnt_reg[0]_i_17_n_2\,
      CO(0) => \cnt_reg[0]_i_17_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_cnt_reg[0]_i_17_O_UNCONNECTED\(3),
      O(2 downto 0) => grp_fu_163_p2(31 downto 29),
      S(3) => '0',
      S(2 downto 0) => cnt_reg(31 downto 29)
    );
\cnt_reg[0]_i_18\: unisim.vcomponents.CARRY4
     port map (
      CI => \cnt_reg[0]_i_22_n_0\,
      CO(3) => \cnt_reg[0]_i_18_n_0\,
      CO(2) => \cnt_reg[0]_i_18_n_1\,
      CO(1) => \cnt_reg[0]_i_18_n_2\,
      CO(0) => \cnt_reg[0]_i_18_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_163_p2(16 downto 13),
...
\cnt_reg[0]_i_20\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_163_p2(8 downto 5),
...
\cnt_reg[0]_i_21\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => cnt_reg(0),
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_163_p2(4 downto 1),
...
\cnt_reg[0]_i_22\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_163_p2(12 downto 9),
...
\pre_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\pre_state[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\pre_state[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\pre_state[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\pre_state_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\shift_reg[6]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\shift_reg[6]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
