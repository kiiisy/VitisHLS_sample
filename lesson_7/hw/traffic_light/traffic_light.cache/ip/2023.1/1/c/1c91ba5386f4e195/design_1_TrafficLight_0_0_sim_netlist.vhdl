...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_TrafficLight is
  ...
  signal \state_reg[0]_i_18_n_0\ : STD_LOGIC;
  signal \state_reg[0]_i_18_n_1\ : STD_LOGIC;
  signal \state_reg[0]_i_18_n_2\ : STD_LOGIC;
  signal \state_reg[0]_i_18_n_3\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \cnt[0]_i_6\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cnt[0]_i_7\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \counter[0]_i_6\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter[0]_i_7\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter[0]_i_8\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter_1[2]_i_4\ : label is "soft_lutpair2";
  ...
  attribute ADDER_THRESHOLD of \state_reg[0]_i_18\ : label is 35;
  attribute ADDER_THRESHOLD of \state_reg[0]_i_19\ : label is 35;
  attribute ADDER_THRESHOLD of \state_reg[0]_i_6\ : label is 35;
  attribute ADDER_THRESHOLD of \state_reg[0]_i_7\ : label is 35;
  attribute SOFT_HLUTNM of \yellow[0]_INST_0\ : label is "soft_lutpair5";
begin
  \^ap_start\ <= ap_start;
  ap_done <= \^ap_start\;
  ap_ready <= \^ap_start\;
...
\counter_1[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => counter_reg(14),
      I3 => counter_reg(9),
      I4 => \counter_1[2]_i_3_n_0\,
      I5 => \counter_1[2]_i_4_n_0\,
      O => \counter_1[2]_i_2_n_0\
    );
\counter_1[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\counter_1[2]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\state_reg[0]_i_14\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_174_p2(20 downto 17),
...
\state_reg[0]_i_16\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_174_p2(8 downto 5),
...
\state_reg[0]_i_17\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_174_p2(28 downto 25),
      S(3 downto 0) => cnt_reg(28 downto 25)
    );
\state_reg[0]_i_18\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \state_reg[0]_i_18_n_0\,
      CO(2) => \state_reg[0]_i_18_n_1\,
      CO(1) => \state_reg[0]_i_18_n_2\,
      CO(0) => \state_reg[0]_i_18_n_3\,
      CYINIT => cnt_reg(0),
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_174_p2(4 downto 1),
...
\state_reg[0]_i_19\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(2 downto 0) => grp_fu_174_p2(31 downto 29),
      S(3) => '0',
...
\state_reg[0]_i_6\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_174_p2(12 downto 9),
...
\state_reg[0]_i_7\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => grp_fu_174_p2(16 downto 13),
